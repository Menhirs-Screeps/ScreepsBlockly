Blockly.Screeps = {
    Constants: {
        PathfindingAlgorithm: [
            ['astar', 'PTHFIND_ASTAR'],
            ['dijkstra', 'PTHFIND_DIJSKTRA']
        ],
        Errors: [
            ['Ok', 'OK'],
            ['Not Owner', 'ERR_NOT_OWNER'],
            ['No Path', 'ERR_NO_PATH'],
            ['Name Exists','ERR_NAME_EXISTS'],
            ['Busy', 'ERR_BUSY'],
            ['Not Found', 'ERR_NOT_FOUND'],
            ['Not Enough Energy', 'ERR_NOT_ENOUGH_ENERGY'],
            ['Not Enough Resources', 'ERR_NOT_ENOUGH_RESOURCES'],
            ['Invalid Target', 'ERR_INVALID_TARGET'],
            ['Full', 'ERR_FULL'],
            ['Not In Range', 'ERR_NOT_IN_RANGE'],
            ['Invalid Args', 'ERR_INVALID_ARGS'],
            ['Tired', 'ERR_TIRED'],
            ['No Bodypart', 'ERR_NO_BODYPART'],
            ['Not Enough Extensions', 'ERR_NOT_ENOUGH_EXTENSIONS'],
            ['RCL Not Enough', 'ERR_RCL_NOT_ENOUGH'],
            ['GCL Not Enough', 'ERR_GCL_NOT_ENOUGH']
        ],
        Finds: [
            ['Find Exit Top', 'FIND_EXIT_TOP'],
            ['Find Exit Right', 'FIND_EXIT_RIGHT'],
            ['Find Exit Bottom', 'FIND_EXIT_BOTTOM'],
            ['Find Exit Left', 'FIND_EXIT_LEFT'],
            ['Find Exit', 'FIND_EXIT'],
            ['Find Creeps', 'FIND_CREEPS'],
            ['Find My Creeps', 'FIND_MY_CREEPS'],
            ['Find Hostile Creeps', 'FIND_HOSTILE_CREEPS'],
            ['Find Sources Active', 'FIND_SOURCES_ACTIVE'],
            ['Find Sources', 'FIND_SOURCES'],
            ['Find Dropped Energy', 'FIND_DROPPED_ENERGY'],
            ['Find Dropped Resources', 'FIND_DROPPED_RESOURCES'],
            ['Find Structures', 'FIND_STRUCTURES'],
            ['Find My Structures', 'FIND_MY_STRUCTURES'],
            ['Find Hostile Structures', 'FIND_HOSTILE_STRUCTURES'],
            ['Find Flags', 'FIND_FLAGS'],
            ['Find Construction Sites', 'FIND_CONSTRUCTION_SITES'],
            ['Find My Spawns', 'FIND_MY_SPAWNS'],
            ['Find Hostile Spawns', 'FIND_HOSTILE_SPAWNS'],
            ['Find My Construction Sites', 'FIND_MY_CONSTRUCTION_SITES'],
            ['Find Hostile Construction Sites', 'FIND_HOSTILE_CONSTRUCTION_SITES'],
            ['Find Minerals', 'FIND_MINERALS'],
            ['Find Nukes', 'FIND_NUKES']
        ],
        Directions: [
            ['top','TOP'],
            ['top right','TOP_RIGHT'],
        ...
        Looks: [
            ['Look Creeps', 'LOOK_CREEPS'],
            ['Look Energy', 'LOOK_ENERGY'],
            ['Look Resources', 'LOOK_RESOURCES'],
            ['Look Sources', 'LOOK_SOURCES'],
            ['Look Minerals', 'LOOK_MINERALS'],
            ['Look Structures', 'LOOK_STRUCTURES'],
            ['Look Flags', 'LOOK_FLAGS'],
            ['Look Construction Sites', 'LOOK_CONSTRUCTION_SITES'],
            ['Look Nukes', 'LOOK_NUKES'],
            ['Look Terrain', 'LOOK_TERRAIN'],
        ],
        ObstacleObjectTypes: [
        ],        
        Bodyparts: [
        ...
        Structures: [
            ...
            ['Road', 'STRUCTURE_ROAD'],
            ['Constructed Wall', 'STRUCTURE_WALL'],
            ['Rampart', 'STRUCTURE_RAMPART'],
            ['Keeper Lair', 'STRUCTURE_KEEPER_LAIR'],
            ...
            ['Power Bank', 'STRUCTURE_POWER_BANK'],
            ['Power Spawn', 'STRUCTURE_POWER_SPAWN'],
        ...
        BasicResources: [
            ...
            ['Ghodium', 'GHODIUM'],
            ['Hydroxide', 'HYDROXIDE'],
            ['Keanite', 'ZYNTHIUM_KEANITE'],
            ['Lemergite', 'UTRIUM_LEMERGITE']
        ],
        CombineResources: [
            ['None', 'NONE'],
            ['Hydride', 'HYDRIDE'],
        ...
        Resources: [
            ...
            ['Keanite', 'RESOURCE_ZYNTHIUM_KEANITE'],
            ['Lemergite', 'RESOURCE_UTRIUM_LEMERGITE'],
            ['Utrium Hydride', 'RESOURCE_UTRIUM_HYDRIDE'],
            ['Utrium Oxide', 'RESOURCE_UTRIUM_OXIDE'],
            ['Keanium Hydride', 'RESOURCE_KEANIUM_HYDRIDE'],
            ['Keanium Oxide', 'RESOURCE_KEANIUM_OXIDE'],
            ['Lemergium Hydride', 'RESOURCE_LEMERGIUM_HYDRIDE'],
            ['Lemergium Oxide', 'RESOURCE_LEMERGIUM_OXIDE'],
            ['Zynthium Hydride', 'RESOURCE_ZYNTHIUM_HYDRIDE'],
            ['Zynthium Oxide', 'RESOURCE_ZYNTHIUM_OXIDE'],
            ['Ghodium Hydrire', 'RESOURCE_GHODIUM_HYDRIDE'],
            ['Ghodium Oxide', 'RESOURCE_GHODIUM_OXIDE'],
            ['Utrium Acid', 'RESOURCE_UTRIUM_ACID'],
            ['Utrium Alkalide', 'RESOURCE_UTRIUM_ALKALIDE'],
            ['Keanium Acid', 'RESOURCE_KEANIUM_ACID'],
            ['Keanium Alkalide', 'RESOURCE_KEANIUM_ALKALIDE'],
            ['Lemergium Acid', 'RESOURCE_LEMERGIUM_ACID'],
            ['Lemergium Alkalide', 'RESOURCE_LEMERGIUM_ALKALIDE'],
            ['Zynthium Acid', 'RESOURCE_ZYNTHIUM_ACID'],
            ['Zynthium Alkalide', 'RESOURCE_ZYNTHIUM_ALKALIDE'],
            ['Ghodium Acid', 'RESOURCE_GHODIUM_ACID'],
            ['Ghodium Alkalide', 'RESOURCE_GHODIUM_ALKALIDE'],
            ['Catalyzed Utrium Acid', 'RESOURCE_CATALYZED_UTRIUM_ACID'],
            ['Catalyzed Utrium Alkalide', 'RESOURCE_CATALYZED_UTRIUM_ALKALIDE'],
            ['Catalyzed Keanium Acid', 'RESOURCE_CATALYZED_KEANIUM_ACID'],
            ['Catalyzed Keanium Alkalide', 'RESOURCE_CATALYZED_KEANIUM_ALKALIDE'],
            ['Catalyzed Lemergium Acid', 'RESOURCE_CATALYZED_LEMERGIUM_ACID'],
            ['Catalyzed Lemergium Alkalide', 'RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE'],
            ['Catalyzed Zynthium Acid', 'RESOURCE_CATALYZED_ZYNTHIUM_ACID'],
            ['Catalyzed Zynthium Alkalide', 'RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE'],
            ['Catalyzed Ghodium Acid', 'RESOURCE_CATALYZED_GHODIUM_ACID'],
            ['Catalyzed Ghodium Alkalide', 'RESOURCE_CATALYZED_GHODIUM_ALKALIDE']
        ],
        TerrainType: [
            ['plain', 'plain'],
            ['swamp', 'swamp'],
